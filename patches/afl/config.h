...
/* Areafuzz-specific macros */
#define FNINDICES_VAR "_FNINDICES_FILE"
...
#define CMPLOG_SHM_ENV_VAR "__AFL_CMPLOG_SHM_ID"
  ...
  #define FUNCMAP_SHM_ENV_VAR "__AFL_FUNCMAP_SHM_ID"
  #define CALLEDGE_SHM_ENV_VAR "__AFL_CALLEDGE_SHM_ID"
  #define INPUTSTATS_ENV_VAR "__INPUTSTATS_SHM_ID"
  #define INIT_DONE_ENV_VAR "__AFL_FUNCMAP_INIT_DONE"

  #define ADDR "127.0.0.1"
  #define MAXDATASIZE 5 
  
  // Static analysis server-client control messages
  // Client-side request
  #define INIT_MODE 1 
  #define FUZZ_MODE 2
  #define CAL_MODE 3
  // Client-side return codes 
  #define INIT_YES 3
  #define INIT_NO 4
  #define CAL_YES 5
  #define CAL_NO 6
  ...
  struct calledge_arr {
      u32 *numelements; // Current number of elements
      u32 *limit; // Max number of elements allowed
      s64 *base_ptr; // Calledge_array base ptr 
  };
   
  #ifdef TRACE_METRIC 
    struct af_input_stats { 
        u64* tracelength_ptr; // Keeps track of the function trace length for each exercised input
    };
    extern struct af_input_stats* input_stat_ptr;
    extern u64 trace_cumulative;
  #endif

  extern struct calledge_arr* calledge_arr_ptr; // Calledge array ptr
  extern u32 prev_num_calledges;
  extern FILE *logfp;
